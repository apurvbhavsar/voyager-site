...
class SiteSettingSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $setting = $this->findSetting('site.header_script');
        if (!$setting->exists) {
            $setting
                ->fill([
                    'display_name' => __('Header Script'),
                    'value' => __('header_script'),
                    'details' => '',
                    'type' => 'text_area',
                    'order' => 9,
                    'group' => 'Site',
        ...
        $setting = $this->findSetting('site.footer_script');
        if (!$setting->exists) {
            $setting
                ->fill([
                    'display_name' => __('Footer Script'),
                    'value' => __('footer_script'),
                    'details' => '',
                    'type' => 'text_area',
                    'order' => 10,
                    'group' => 'Site',
